...
public class PopulationQuery {
	...
	public static void main(String[] args) {
		...
		switch (args[2]) {
		case "-v1":
			SequentialSearch _ = new SequentialSearch(data, gridSize);
			break;
		case "-v2":
			System.out.println("starting 2");
			ParallelController pc = new ParallelController(data, gridSize);
			break;
		case "-v3":
			System.out.println("starting 3");
			SmartSequentialSearch ss = new SmartSequentialSearch(data, gridSize);
			break;
		default:
